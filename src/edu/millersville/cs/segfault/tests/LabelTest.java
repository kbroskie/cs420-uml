...
public class LabelTest {
	...
	public void test() {
		...
		assertTrue("Height not correct", testLabel1.getHeight() == 15);
		assertTrue("Width not correct", testLabel1.getWidth() == 10);
		
		testLabel1 = testLabel1.alterText(testLabel2.text);
		assertTrue("Label not set correctly", testLabel1.text == "Princess Luna");
